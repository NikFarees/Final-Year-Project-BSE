...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $stmt = $conn->prepare("INSERT INTO feedback (feedback_id, feedback_category_id, user_id, description) VALUES (?, ?, ?, ?)");
        $stmt->bind_param("ssss", $feedback_id, $feedback_category_id, $user_id, $description);
        if ($stmt->execute()) {
