...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $studentStmt = $conn->prepare($updateStudentQuery);
    $studentStmt->bind_param("sss", $bank_number, $bank_name, $currentUserId);

    if ($userStmt->execute() && $studentStmt->execute()) {
          ...
          <form method="POST" action="">
            ...
            <div class="row mb-3">
              <div class="col-md-6">
                ...
                <input type="text" id="bank_number" name="bank_number" class="form-control" value="<?php echo htmlspecialchars($user['bank_number']); ?>">
              </div>
              <div class="col-md-6">
