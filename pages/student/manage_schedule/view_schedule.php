                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h4 class="card-title">License Progress</h4>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-category">
                                                    Your journey toward obtaining a driver's license
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="progress-card mb-4">
                                                    ...
                                                    <div class="alert alert-info mt-2 mb-3 py-2">
                                                        <?php if ($data['license']['lesson_id'] == 'LES01' || $data['license']['lesson_id'] == 'LES02'): ?>
                                                            <small><i class="fas fa-info-circle"></i> You need to complete 100% progress to get your license.</small>
                                                        <?php else: ?>
                                                            <small><i class="fas fa-info-circle"></i> You need to complete 83.33% progress to get your license.</small>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="timeline">
                                                        ...
                                                        foreach ($journey_sequence as $step) {
                                                            ...
                                                            if ($step === 'Driving Lessons') {
                                                                ...
                                                                echo '<p class="text-muted">Complete all tests and lessons to receive your license certificate.</p>';
                                                                echo '</div>';
                                                                echo '</div>';
                                                                echo '</div>';
                                                            } else {
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center py-5">
                                    ...
                                    <p>You haven't enrolled in any driving license program yet.</p>
                                    <a href="/pages/student/book_license/list_license.php" class="btn btn-primary mt-3">Enroll Now</a>
                                </div>
                            </div>
                        </div>
                    </div>
