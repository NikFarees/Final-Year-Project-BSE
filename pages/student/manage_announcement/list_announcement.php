...
// Get the current student's user_id from session
$user_id = $_SESSION['user_id'] ?? '';
$role_id = $_SESSION['role_id'] ?? '';

// Fetch announcements relevant to this student (targeted to their role or specifically to them)
$query = "
    SELECT 
        a.announcement_id,
        a.title,
    ...
    WHERE 
        a.announcement_id IN (
            -- Announcements targeted to the student's role
